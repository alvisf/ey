...
public class Shoe {
	public static void main(String[] args)throws Exception {
		...
		Shoes
		shoes=shop.sellShoe(new ShoeCustomer("ramu"));
		System.out.println("Shoe....:"+shoes);
		System.out.println("..........................................");
		}
	}
}
...
class LeatherShoe extends Shoes{
	@Override
...
class SportsShoe extends Shoes{
	@Override
	public String toString() {
		// TODO Auto-generated method stub
...
interface ShoeSeller extends Seller{
	public Shoes sellShoe(Customer customer);
}
